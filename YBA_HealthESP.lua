...
local waitduration = 1 -- the amount of time before the ESP updates (removes all current ESP objects and makes new ones)
            ...
            if v.Character and v~=plr then
                if game:GetService('CoreGui'):FindFirstChild(v.Name) == nil then
                    ...
                    if v.Character:FindFirstChild('Head') then
                        ...
                        text.Text = v.Name .. " | " .. round(v.Character.Health.Value)
